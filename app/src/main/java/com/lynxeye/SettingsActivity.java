...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch swVisualizer = findViewById(R.id.swVisualizer);
        ...
        swVisualizer.setOnCheckedChangeListener((v, c) -> {
            AppSettings.setVisualizerEnabled(this, c);
            Toast.makeText(this, c ? "Visualizer enabled" : "Visualizer disabled", Toast.LENGTH_SHORT).show();
        });

        rgAudioMode.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId == R.id.rbHighQuality) { AppSettings.setAudioMode(this, 1); Toast.makeText(this, "High quality - stereo PCM", Toast.LENGTH_SHORT).show(); }
            else if (checkedId == R.id.rbLowBandwidth) { AppSettings.setAudioMode(this, 2); Toast.makeText(this, "Low bandwidth mode", Toast.LENGTH_SHORT).show(); }
            else { AppSettings.setAudioMode(this, 0); Toast.makeText(this, "Normal mode", Toast.LENGTH_SHORT).show(); }
        });
